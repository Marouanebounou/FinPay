...
public class CalcultotalfacturesprestataireTest {
    ...
    void testCalculerTotalFactures() {
        ...
        assertEquals(2, resultats.size(), "Il devrait y avoir exactement 2 prestataires");
        ...
        for (Facture f : resultats) {
            ...
            if (f.getId_pre() == 1) {
                ...
                assertEquals(0, new BigDecimal("4700.50").compareTo(f.getBalance()));
            }
                ...
                assertEquals(2, f.getNombreFactures());
                assertEquals(0, new BigDecimal("5850.00").compareTo(f.getBalance()));
            }
        }

        assertTrue(found1, "Prestataire 1 non trouve.");
        assertTrue(found2, "Prestataire 2 non trouve.");
    }
    ...
    void testCasListeVide() {
        ...
        assertTrue(resultats.isEmpty(), "La liste devrait être vide.");
    }
}